...
class Ui_tumor_seg(object):
    ...
    def retranslateUi(self, tumor_seg):
        ...
        tumor_seg.setWindowTitle(_translate("tumor_seg", "LTS by using u-net Version 0.9 PHD.Imtithal - SIU Graduate Project"))
        self.choose_raw.setText(_translate("tumor_seg", "حدد المسار"))
        self.state_show_label1.setText(_translate("tumor_seg", "No task"))
        self.show_1.setText(_translate("tumor_seg", "عرض"))
        self.left.setText(_translate("tumor_seg", "السابق"))
        self.right_R.setText(_translate("tumor_seg", "التالي"))
        self.seg_run.setText(_translate("tumor_seg", "تم تنفيذها"))
        self.label.setText(_translate("tumor_seg", "mark"))
        self.label_3.setText(_translate("tumor_seg", "Layer display"))
        self.label_4.setText(_translate("tumor_seg", "Status Display"))
        self.tri_d_run.setText(_translate("tumor_seg", "تم تنفيذها"))
        self.label_5.setText(_translate("tumor_seg", "3D reconstruction"))
        
        
        self.tumor_layer.setText(_translate("tumor_seg", "Tumor layer"))
        self.liver_layer.setText(_translate("tumor_seg", "Liver layer"))
        
        
        self.liver_mark.setText(_translate("tumor_seg", "Liver marker"))
        self.tumor_mark.setText(_translate("tumor_seg", "Tumor markers"))
